...
int main_ini (void)
{
    ...
    nret=ECM_EcatInit(0x0030, TEST_CYCTIME, TEST_CYCTIME/2);
	...
	if(u16PDOSize != TEST_RXPDO_BUF_SIZE){ //TEST_RXPDO_BUF_SIZE = TEST_RXPDO_SIZE*TEST_SERVO_CNT=6*4
